...
app.config['SQLALCHEMY_DATABASE_URI'] 	= 'sqlite:////Users/Sanjay/Documents/THIRD_YEAR_STUFF/SEMESTER_6/CLOUD_COMPUTING/test8.db'
db.init_app(app)
...
def ride_details(rideid):
    ...
    resp_data = {'table': "ride", 'columns': [
        "created_by", "timestamp", "source", "destination", "users"], "where": "rideId="+rideid,"delete":"False"}
